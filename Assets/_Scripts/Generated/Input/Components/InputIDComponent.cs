...
public partial class InputEntity {
    ...
    public Project0.IDComponent iD { get { return (Project0.IDComponent)GetComponent(InputComponentsLookup.ID); } }
    ...
    public void AddID(int newValue) {
        ...
        var component = CreateComponent<Project0.IDComponent>(index);
